...
from synapse.modules.synapse_user_restrictions.config import (
...
class UserRestrictionsModule:
    def __init__(self, config: UserRestrictionsModuleConfig, api: ModuleApi):
        ...
        api.register_spam_checker_callbacks(
            ...
            user_may_publish_room=self.callback_user_may_publish_room,
    ...
    async def callback_user_may_publish_room(self, user: str) -> bool:
        return self._apply_rules(user, PUBLISH_ROOM) 
